...
namespace SoftQuanLyNhaHang.Models
{
    class connection
    {
        public static string sqlcon = "Server=DESKTOP-37T0935\\VUAVUNGCAO;Database=dbBilliardsManagement;Trusted_Connection=True;TrustServerCertificate=Yes;MultipleActiveResultSets=true";
